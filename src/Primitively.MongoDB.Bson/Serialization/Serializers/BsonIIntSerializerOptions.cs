...
/// <summary>
/// Represents the options used to configure the BSON serialization of Primitively <see cref="IInt"/> types.
/// </summary>
public class BsonIIntSerializerOptions : IBsonConvertibleSerializerOptions<BsonIIntSerializerOptions>
{
    /// <summary>
    /// Gets the <see cref="Primitively.DataType"/> of the Primitively <see cref="IInt"/> type.
    /// </summary>
    /// <value><see cref="DataType.Int"/></value>
    public DataType DataType { get; } = DataType.Int;

    /// <summary>
    /// Gets or sets the <see cref="BsonType"/> used to represent the Primitively <see cref="IInt"/> type.
    /// </summary>
    /// <value><see cref="BsonType.Int32"/></value>
    public BsonType Representation { get; set; } = BsonType.Int32;

    /// <summary>
    /// Gets or sets the type used to serialize Primitively <see cref="IInt"/> types.
    /// </summary>
    /// <value><![CDATA[typeof(BsonIIntSerializer<>)]]></value>
    ...
    /// <summary>
    /// Gets or sets the function used to create an instance of the type used to serialize Primitively <see cref="IInt"/> types.
    /// </summary>
