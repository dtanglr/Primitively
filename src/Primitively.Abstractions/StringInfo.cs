...
/// <summary>
/// The StringInfo record contains metadata about a Primitively <see cref="IString"/> type.
/// </summary>
...
/// <param name="Pattern">An optional regular expression pattern used to ensure that only valid values are encapsulated.</param>
