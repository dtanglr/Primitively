...
public class FluentValidationTests
{
    ...
    private record Sut(DecimalId Property, DecimalId? NullableProperty);
    ...
    [InlineData(DecimalId.Example, true, true)]
    ...
    {
        var sut = new Sut(DecimalId.Parse(value), value is null ? null : DecimalId.Parse(value));
