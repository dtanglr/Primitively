...
public class FluentValidationTests
{
    ...
    private record Sut(ThirtyEightDigitsWithHyphensAndParentheses Property, ThirtyEightDigitsWithHyphensAndParentheses? NullableProperty);
    ...
    {
        var sut = new Sut(ThirtyEightDigitsWithHyphensAndParentheses.Parse(value), value is null ? null : ThirtyEightDigitsWithHyphensAndParentheses.Parse(value));
